...
const ShowCard = ({ artist, showName, urlShow, urlShowImage, date, place }) => {
  return (
    <div className="flex flex-row w-[512px] h-[251px] bg-[#262627] rounded-lg p-4 gap-5">
      {/* Show Image */}
      <div className="w-[225px] h-[225px] flex-shrink-0 rounded-md overflow-hidden">
      ...
      <div className="flex flex-col justify-center gap-6 w-full">
        ...
        <div className="flex flex-col gap-2 ml-8">
          ...
          <h2 className="text-[26px] font-medium text-white leading-tight line-clamp-1">
            {artist}
          </h2>
        </div>
        ...
        <a
          href={urlShow}
          className="group text-[#00DAF0] hover:text-[#7cf3ff] transition ml-8"
        >
          <div className="flex items-center gap-3">
